...
// scroll container (see .feed-page-root / .pp-root, via the shared
// --mobile-tabbar-h variable) so content isn't hidden behind it.
export default function MobileTabBarLayout({ activeTab, pendingCount = 0 }) {
  ...
  return (
    <nav aria-label="主要導覽" style={{ position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 500 }}>
